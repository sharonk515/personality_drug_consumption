...
def category_converter(df):
    ...
    Parameter
    ----------
    df: Dataframe with age, gender, country, ethnicity,
    and education as a categorical variable
    Returns
    --------
...
def encoding(df):
    ...
    Return
    -----------
    Dataframe with age and education as an ordinal variable
    and gender as dummy variable
    '''
    ages = {'18-24': 0,
            '25-34': 1,
            '35-44': 2,
